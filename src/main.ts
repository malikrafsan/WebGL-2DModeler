...
const main = () => {
  ...
  const vertex = new Vertex(0, 1, new Color(0, 0, 0), gl);
  const vertex2 = new Vertex(1, 1, new Color(50, 50, 50), gl);
  const vertex3 = new Vertex(0, 0, new Color(100, 100, 100), gl);
  const vertex4 = new Vertex(1, 0, new Color(200, 200, 200), gl);
